...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO service (service_name, price, description, foto) VALUES
            ('$nama', '$price', '$description', '$nama_foto')");
        }
    } else {
        $insert = mysqli_query($koneksi, "INSERT INTO service (service_name, price, description) VALUES
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE service SET service_name='$nama', price='$price', description='$description' WHERE id='$id'");
