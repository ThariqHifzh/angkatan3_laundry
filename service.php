                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-success btn-sm"
                                                                href="tambah-service.php?edit=<?php echo $rowService['id'] ?>"><span class="tf-icon bx bx-pencil"></a>

                                                            <a class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Apakah Anda Yakin untuk Menghapus Data Ini?')"
                                                                href="service.php?delete=<?php echo $rowService['id'] ?>"><span class="tf-icon bx bx-trash"></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
