...
if (isset($_POST['simpan'])) {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (!in_array($extFoto, $ext)) {
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO level (nama_level) VALUES
            ('$nama')");
        }
    } else {
        $insert = mysqli_query($koneksi, "INSERT INTO level (nama_level) VALUES
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_level" placeholder="Masukkan Nama Level" required value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_level'] : '' ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3">
